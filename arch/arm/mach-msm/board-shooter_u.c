...
static void config_flashlight_gpios(void)
{
	static uint32_t flashlight_gpio_table[] = {
		GPIO_CFG(SHOOTER_U_FLASH_EN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
		GPIO_CFG(SHOOTER_U_FLASH_TORCH, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
		GPIO_CFG(SHOOTER_U_FLASH_RST, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	};
	...
	gpio_set_value(SHOOTER_U_FLASH_RST, 1);
}

static struct TPS61310_flashlight_platform_data flashlight_data = {
	.gpio_init = config_flashlight_gpios,
	.tps61310_strb1 = SHOOTER_U_FLASH_TORCH,
	.tps61310_strb0 = SHOOTER_U_FLASH_EN,
...
static uint32_t mhl_gpio_table[] = {
	...
	GPIO_CFG(SHOOTER_U_GPIO_MHL_WAKE_UP, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};
...
static uint32_t gsbi3_gpio_table[] = {
	GPIO_CFG(SHOOTER_U_GPIO_FL_I2C_SDA, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_U_GPIO_FL_I2C_SCL, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};

static uint32_t gsbi3_gpio_table_gpio[] = {
	GPIO_CFG(SHOOTER_U_GPIO_FL_I2C_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_U_GPIO_FL_I2C_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};
...
static uint32_t gsbi5_gpio_table[] = {
	GPIO_CFG(SHOOTER_U_GPIO_TP_I2C_SDA, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_U_GPIO_TP_I2C_SCL, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};

static uint32_t gsbi5_gpio_table_gpio[] = {
	GPIO_CFG(SHOOTER_U_GPIO_TP_I2C_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_U_GPIO_TP_I2C_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};
...
static uint32_t gsbi8_gpio_table[] = {
	GPIO_CFG(SHOOTER_U_GPIO_QTR_SDA, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_U_GPIO_QTR_SCL, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};

static uint32_t gsbi8_gpio_table_gpio[] = {
	GPIO_CFG(SHOOTER_U_GPIO_QTR_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_U_GPIO_QTR_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};
...
static uint32_t gsbi12_gpio_table[] = {
	GPIO_CFG(SHOOTER_U_GPIO_CAP_I2C_SDA, 2, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIOMUX_DRV_8MA),
	GPIO_CFG(SHOOTER_U_GPIO_CAP_I2C_SCL, 2, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIOMUX_DRV_8MA),
};

static uint32_t gsbi12_gpio_table_gpio[] = {
	GPIO_CFG(SHOOTER_U_GPIO_CAP_I2C_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_U_GPIO_CAP_I2C_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
};
...
static struct dsps_gpio_info dsps_shooter_u_gpios[] = {
...
static void __init msm8x60_init_dsps(void)
{
	...
	pdata->gpios = dsps_shooter_u_gpios;
	pdata->gpios_num = ARRAY_SIZE(dsps_shooter_u_gpios);
...
static struct atmel_i2c_platform_data ts_atmel_data[] = {
	{
		...
		.abs_width_min    = 0,
		.abs_width_max    = 20,
		.gpio_irq         = SHOOTER_U_GPIO_TP_ATTz,
		.unlock_attr      = 1,
...
static struct i2c_board_info msm_i2c_gsbi5_info[] = {
	{
		...
		.irq = MSM_GPIO_TO_INT(SHOOTER_U_GPIO_TP_ATTz)
	},
};
...
static int cy8c_cs_reset(void)
{
	...
	gpio_set_value_cansleep(SHOOTER_U_GPIO_CAP_RST, 1);
	msleep(5);
	gpio_set_value_cansleep(SHOOTER_U_GPIO_CAP_RST, 0);
...
static struct cy8c_i2c_cs_platform_data cs_cy8c_data[] = {
	{
		.gpio_irq     = SHOOTER_U_GPIO_CAP_ATTz,
		.gpio_rst     = SHOOTER_U_GPIO_CAP_RST,
		.reset        = cy8c_cs_reset,
...
static struct i2c_board_info msm_i2c_gsbi12_info[] = {
	{
		...
		.irq = MSM_GPIO_TO_INT(SHOOTER_U_GPIO_CAP_ATTz),
	},
};
...
static uint32_t headset_cpu_gpio[] = {
	GPIO_CFG(SHOOTER_U_AUD_UART_RX, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_U_AUD_UART_TX, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_U_AUD_UART_RX, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTER_U_AUD_UART_TX, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};
...
static void uart_tx_gpo(int mode)
{
	switch (mode) {
		case 0:
			...
			gpio_set_value_cansleep(SHOOTER_U_AUD_UART_TX, 0);
			break;
		case 1:
			gpio_tlmm_config(headset_cpu_gpio[1], GPIO_CFG_ENABLE);
			gpio_set_value_cansleep(SHOOTER_U_AUD_UART_TX, 1);
			break;
		case 2:
...
{
	gpio_set_value_cansleep(PM8058_GPIO_PM_TO_SYS(SHOOTER_U_AUD_UART_OE), enable);
}

static struct htc_headset_1wire_platform_data htc_headset_1wire_data = {
	.tx_level_shift_en	= PM8058_GPIO_PM_TO_SYS(SHOOTER_U_AUD_UART_OE),
	.uart_sw		= 0,
...
static void headset_init(void)
{
	...
	gpio_tlmm_config(GPIO_CFG(SHOOTER_U_AUD_UART_TX, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), 0);
	gpio_tlmm_config(GPIO_CFG(SHOOTER_U_AUD_UART_RX, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), 0);
}
...
static void headset_power(int enable)
{
	...
	int rc;
		...
		ret = gpio_request(PM8058_GPIO_PM_TO_SYS(SHOOTER_U_AUD_2V85_EN), "HS_MIC_BIAS");
		if (ret)
			pr_err("[HS]Request Headset MIC bias error\n");
		else {
		ret = gpio_direction_output(PM8058_GPIO_PM_TO_SYS(SHOOTER_U_AUD_2V85_EN), enable);
		if (ret)
			pr_err("[HS]Set MIC bias to %d error\n", enable);
		gpio_free(PM8058_GPIO_PM_TO_SYS(SHOOTER_U_AUD_2V85_EN));
		}
...
static struct msm_rtb_platform_data shooter_u_rtb_pdata = {
...
static int __init msm_rtb_set_buffer_size(char *p)
{
	...
	s = memparse(p, NULL);
	shooter_u_rtb_pdata.size = ALIGN(s, SZ_4K);
	return 0;
}
early_param("msm_rtb_size", msm_rtb_set_buffer_size);


static struct platform_device shooter_u_rtb_device = {
	.name           = "msm_rtb",
	.id             = -1,
	.dev            = {
		.platform_data = &shooter_u_rtb_pdata,
	},
};
#endif
...
static int pm8058_gpios_init(void)
{
	...
	struct pm8058_gpio_cfg gpio_cfgs[] = {
...
#ifdef CONFIG_MSM8X60_AUDIO 
		{ 
			PM8058_GPIO_PM_TO_SYS(SHOOTER_U_AUD_HANDSET_ENO),
			{
		...
		{ 
			PM8058_GPIO_PM_TO_SYS(SHOOTER_U_AUD_UART_OE),
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 1,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
		...
		{
			PM8058_GPIO_PM_TO_SYS(SHOOTER_U_AUD_2V85_EN),
			{
				.direction	= PM_GPIO_DIR_OUT,
				.output_value	= 0,
				.output_buffer	= PM_GPIO_OUT_BUF_CMOS,
...
static struct tpa2051d3_platform_data tpa2051d3_pdata = {
	.gpio_tpa2051_spk_en = PM8058_GPIO_PM_TO_SYS(SHOOTER_U_AUD_SPK_ENO),
...
static uint32_t __initdata shooter_u_regulator_lpm_set[] =
{
...
static void __init msm8x60_init(struct msm_board_data *board_data)
{
	...
	msm_rpm_lpm_init(shooter_u_regulator_lpm_set, ARRAY_SIZE(shooter_u_regulator_lpm_set));
