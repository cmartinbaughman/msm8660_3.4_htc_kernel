...
static int pm8058_gpios_init(void)
{
	...
	struct pm8058_gpio_cfg gpio_cfgs[] = {
...
#endif
		{
			PM8058_GPIO_PM_TO_SYS(SHOOTER_U_AUD_MIC_SEL),
			{
		...
		{
			PM8058_GPIO_PM_TO_SYS(sHOOTER_U_PLS_INT),
			{
				.direction		= PM_GPIO_DIR_IN,
...
#endif
		{
			PM8058_GPIO_PM_TO_SYS(SHOOTER_U_VOL_UP),
			{
				.direction      = PM_GPIO_DIR_IN,
		...
		{ 
			PM8058_GPIO_PM_TO_SYS(SHOOTER_U_VOL_DN),
			{
				.direction      = PM_GPIO_DIR_IN,
				.pull           = PM_GPIO_PULL_UP_1P5,
				.vin_sel        = 2,
...
static uint32_t msm_spi_gpio[] = {
	GPIO_CFG(SHOOTER_U_SPI_DO,  1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_U_SPI_DI,  1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_U_SPI_CS,  1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTER_U_SPI_CLK, 1, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_8MA),
...
static struct tpa2051d3_platform_data tpa2051d3_pdata = {
	.gpio_tpa2051_spk_en = PM8058_GPIO_PM_TO_SYS(SHOOTER_U_AUD_HP_EN),
...
static struct isl29028_platform_data isl29028_pdata = {
	.intr = PM8058_GPIO_PM_TO_SYS(SHOOTER_U_PLS_INT),
...
static struct i2c_board_info i2c_isl29028_devices[] = {
	{
		...
		.irq = PM8058_GPIO_IRQ(PM8058_IRQ_BASE, SHOOTER_U_PLS_INT),
	},
};
#endif
